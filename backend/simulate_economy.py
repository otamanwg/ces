...
class EconomySimulator:
    def __init__(self):
        ...
        self.players = [
            {"name": "Богдан (Новачок)", "balance": 500.0, "energy": 100, "mood": 100, "hourly_wage": 25.0, "rent": 15.0, "education": "High School"},
            {"name": "Олена (Менеджер)", "balance": 1200.0, "energy": 100, "mood": 100, "hourly_wage": 45.0, "rent": 25.0, "education": "College"},
            {"name": "Дмитро (Інвестор)", "balance": 5000.0, "energy": 100, "mood": 100, "hourly_wage": 80.0, "rent": 50.0, "education": "University"}
        ]
    ...
    def trigger_disaster(self):
        ...
        disasters = [
            {"name": "Прорив міського водоканалу 💧", "cost_treasury": 1500.0, "cost_player": 100.0, "desc": "Комунальна аварія вимагає фінансування з казенних коштів на ремонт та змушує гравців сплатити за позаплановий виклик сантехніка."},
            {"name": "Локальний неврожай у регіоні 🌾", "cost_treasury": 500.0, "cost_player": 200.0, "desc": "Ціни на продукти харчування в магазинах зростають. Скарбниця виділяє дотації, гравці витрачають більше на відновлення енергії."},
            {"name": "Аварія електромережі міста ⚡", "cost_treasury": 1000.0, "cost_player": 50.0, "desc": "Електрика вимкнулась на кілька годин, знижуючи настрій та вимагаючи казенного ремонту."}
        ]
        ...
        print(f"   Наслідки: Скарбниця втратила {event['cost_treasury']} грн, кожен гравець витратив {event['cost_player']} грн на усунення наслідків.")
    ...
    def run_shift_cycle(self, cycle_num: int, initial_circulation: float):
        ...
        for p in self.players:
            print(f"   👤 {p['name']}: Баланс = {round(p['balance'], 2)} грн | Енергія = {p['energy']}% | Настрій = {p['mood']}%")
