...
class TestCasino:
    def test_blackjack_win_or_loss(self, db, city):
    ...
    def test_blackjack_insufficient_balance(self, db, city):
    ...
    def test_roulette_red_black(self, db, city):
    ...
    def test_roulette_number_payout(self, db, city):
    ...
    def test_poker_create(self, db, city, player):
        casino = _make_business(db, city, player, "casino", cash=50000.0)
    ...
    def test_casino_tax_collection(self, db, city, player):
        casino = _make_business(db, city, player, "casino", cash=50000.0)
    ...
    def test_casino_license_fee(self, db, city, player):
    ...
    def test_casino_shutdown(self, db, city, player):
        casino = _make_business(db, city, player, "casino", cash=5000.0)
...
class TestAtelier:
    def test_create_skin_common(self, db, city, player):
        atelier = _make_business(db, city, player, "atelier", cash=5000.0)
    ...
    def test_create_skin_unique_forces_one_copy(self, db, city, player):
        atelier = _make_business(db, city, player, "atelier", cash=5000.0)
        from backend.app.services.atelier_service import create_skin
    ...
    def test_create_skin_invalid_rarity(self, db, city, player):
        atelier = _make_business(db, city, player, "atelier", cash=5000.0)
        from backend.app.services.atelier_service import create_skin

        result = create_skin(db, player, atelier, "Bad", {}, "mythic", False, 1, Decimal("100"))
        assert result["success"] is False

    def test_buy_skin(self, db, city, player):
        designer = player
        ...
        skin_result = create_skin(db, designer, atelier, "For Sale", {"hair": "red"}, "rare", False, 5, Decimal("300"))
        db.flush()
    ...
    def test_buy_skin_insufficient_balance(self, db, city, player):
        designer = player
    ...
    def test_equip_skin(self, db, city, player):
        designer = player
    ...
    def test_list_skins_for_sale(self, db, city, player):
        atelier = _make_business(db, city, player, "atelier", cash=5000.0)
        from backend.app.services.atelier_service import create_skin, list_skins_for_sale

        create_skin(db, player, atelier, "S1", {}, "common", False, 5, Decimal("100"))
        create_skin(db, player, atelier, "S2", {}, "rare", False, 3, Decimal("300"))
        db.flush()
...
class TestShadow:
    def test_add_criminal_rep(self, db, city, player):
    ...
    def test_criminal_rep_clamped_to_100(self, db, city, player):
        from backend.app.services.shadow_service import add_criminal_rep
    ...
    def test_criminal_rep_clamped_to_0(self, db, city, player):
        from backend.app.services.shadow_service import add_criminal_rep
    ...
    def test_decay_criminal_rep(self, db, city, player):
    ...
    def test_open_shadow_business_requires_rep(self, db, city, player, district):
    ...
    def test_open_shadow_business_with_rep(self, db, city, player, district):
    ...
    def test_open_shadow_business_invalid_type(self, db, city, player, district):
        from backend.app.services.shadow_service import (
            add_criminal_rep,
            open_shadow_business,
        )
    ...
    def test_shadow_business_income(self, db, city, player, district):
        from backend.app.services.shadow_service import (
            add_criminal_rep,
            open_shadow_business,
    ...
    def test_check_discovery_no_discovery(self, db, city, player, district):
        from backend.app.services.shadow_service import (
            add_criminal_rep,
            check_discovery,
            open_shadow_business,
    ...
    def test_offer_fraud_low_rep_no_offer(self, db, city, player):
    ...
    def test_accept_fraud(self, db, city, player):
    ...
    def test_refuse_fraud(self, db, city, player):
        from backend.app.services.shadow_service import (
            add_criminal_rep,
            refuse_fraud,
        )
    ...
    def test_money_laundering(self, db, city):
    ...
    def test_shadow_market_buy_requires_rep(self, db, city, player):
        from backend.app.services.shadow_service import shadow_market_buy

        result = shadow_market_buy(db, player, "electronics", 5)
        assert result["success"] is False  # criminal_rep = 0

    def test_shadow_market_buy_with_rep(self, db, city, player):
        from backend.app.services.shadow_service import (
            add_criminal_rep,
            shadow_market_buy,
        )
    ...
    def test_shadow_market_sell_with_rep(self, db, city, player):
        from backend.app.services.shadow_service import (
            add_criminal_rep,
            shadow_market_sell,
        )
