...
def _make_city(db) -> City:
    city = City(name="G10TestCity", treasury_balance=Decimal("100000.00"), game_day=0)
    db.add(city)
    db.flush()
    return city
...
class TestEducationEnroll:
    ...
    def test_enroll_full_time(self):
    ...
    def test_enroll_part_time(self):
        db = make_test_session(TEST_DATABASE_URL)
        try:
            city = _make_city(db)
    ...
    def test_enroll_one_full_one_part_parallel(self):
        db = make_test_session(TEST_DATABASE_URL)
        try:
            city = _make_city(db)
    ...
    def test_cannot_enroll_two_full_time(self):
        db = make_test_session(TEST_DATABASE_URL)
        try:
            city = _make_city(db)
    ...
    def test_cannot_enroll_two_part_time(self):
        db = make_test_session(TEST_DATABASE_URL)
        try:
            city = _make_city(db)
    ...
    def test_cannot_enroll_duplicate(self):
        db = make_test_session(TEST_DATABASE_URL)
        try:
            city = _make_city(db)
    ...
    def test_enroll_insufficient_funds(self):
        db = make_test_session(TEST_DATABASE_URL)
        try:
            city = _make_city(db)
...
class TestEducationComplete:
    def test_complete_education(self):
        db = make_test_session(TEST_DATABASE_URL)
        try:
            city = _make_city(db)
    ...
    def test_revoke_education(self):
        db = make_test_session(TEST_DATABASE_URL)
        try:
            city = _make_city(db)
...
class TestExams:
    ...
    def test_bribe_requires_two_fails(self):
        db = make_test_session(TEST_DATABASE_URL)
        try:
            city = _make_city(db)
    ...
    def test_bribe_after_fails(self):
        db = make_test_session(TEST_DATABASE_URL)
        try:
            city = _make_city(db)
    ...
    def test_bribe_insufficient_funds(self):
        db = make_test_session(TEST_DATABASE_URL)
        try:
            city = _make_city(db)
...
class TestLicenses:
    def test_lawyer_license_requires_education(self):
        db = make_test_session(TEST_DATABASE_URL)
        try:
            city = _make_city(db)
    ...
    def test_lawyer_license_with_education_and_exam(self):
        db = make_test_session(TEST_DATABASE_URL)
        try:
            city = _make_city(db)
    ...
    def test_police_qualification(self):
        db = make_test_session(TEST_DATABASE_URL)
        try:
            city = _make_city(db)
    ...
    def test_judge_qualification(self):
        db = make_test_session(TEST_DATABASE_URL)
        try:
            city = _make_city(db)
    ...
    def test_mayor_eligibility_not_eligible(self):
        db = make_test_session(TEST_DATABASE_URL)
        try:
            city = _make_city(db)
    ...
    def test_mayor_eligibility_with_education_and_practice(self):
        db = make_test_session(TEST_DATABASE_URL)
        try:
            city = _make_city(db)
...
class TestFakeDiploma:
    def test_buy_fake_diploma(self):
        db = make_test_session(TEST_DATABASE_URL)
        try:
            city = _make_city(db)
    ...
    def test_buy_fake_diploma_insufficient_funds(self):
        db = make_test_session(TEST_DATABASE_URL)
        try:
            city = _make_city(db)
    ...
    def test_buy_fake_diploma_duplicate(self):
        db = make_test_session(TEST_DATABASE_URL)
        try:
            city = _make_city(db)
    ...
    def test_expose_fake_diploma(self):
        db = make_test_session(TEST_DATABASE_URL)
        try:
            city = _make_city(db)
    ...
    def test_expose_real_diploma_fails(self):
        db = make_test_session(TEST_DATABASE_URL)
        try:
            city = _make_city(db)
