...
- Додати repair/reopen flow для `maintenance_due`, щоб прострочене утримання було м'яким ігровим станом, а не безвихідною втратою активу.
- Додати building portfolio API як контракт для Godot UI: статуси, fees, blueprint summary і доступні дії.
