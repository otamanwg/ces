...
1. [x] Education panel: дерево курсів, поточна освіта, кнопка іспиту, ліцензії.
2. [x] Police panel: ієрархія, патрулювання, арешти, конфіскація (для гравця-поліцейського).
3. [x] Court/Prison panel: активні справи, вердикти, апеляції, термін ув'язнення.
4. [x] Press panel: розслідування, публікації, реклама, шантаж.
5. [x] Casino panel: блекджек/рулетка UI, ставка, результат.
6. [x] Shadow economy panel: criminal_rep, fraud offers, shadow market, shadow businesses.
7. [x] Political panel: вибори, голосування, кандидати, AI-mayor інвестиції.
8. [x] Lawyer panel: супровід угод, апеляція, захист.
9. [x] Atelier panel: створення скінів, продаж, equip/unequip.
10. [x] Bank panel: депозити, кредити, аукціони.
